...
<img src="05.webp" width="390px" > 
<div style="width:390px;background-color:white;height:500px" >
 <button onclick="location.href='finish.html';" style="width: 300px;height:50px;border: 1px solid black;margin-top:100px" class="btn btn-primary" id="irsblack" >تایید و مرحله بعد</button>
</div>
