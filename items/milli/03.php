...
<meta name="viewport" content="width=device-width">
 ...
 <link rel="stylesheet" type="text/css" href="./../../css/5/bootstrap.rtl.min.css">
  <link rel="stylesheet" type="text/css" href="./../../css/bootstrapmin.css">
 <link rel="stylesheet" type="text/css" href="./../../css/5/bootstrap-reboot.rtl.min.css">
 <link rel="stylesheet" type="text/css" href="./../../css/5/bootstrap-grid.rtl.min.css">
...
<img src="03.webp" width="390px" > 

<div style="width:390px;background-color:white" >
 <input type="number" style="font-family:irsblack;width:250px; text-align:center;font-size:20px" >
 </div>
 <div style="width:390px;background-color:white;height:500px" >
  <button onclick="location.href='04.php';" style="width: 300px;height:50px;border: 1px solid black;margin-top:100px" class="btn btn-primary" id="irsblack" >تایید و مرحله بعد</button>
 </div>
 </center>
